...
SQUADS = {
    ...
    "스쿼드3": {
        ...
        "expected": (3_149_419_919, 30_094_455),
        "char_avg": {
            "토브":                  40_153_937,
            "아르카나 : 포츈 메이트": 641_254_272,
            "도로시 : 세렌디피티":   1_221_728_450,
            "드레이크":               817_234_371,
            "솔린 : 프로스트 티켓":   429_048_887,
        },
    },
    "스쿼드4": {
        "members": ["목단", "마스트 : 로망틱 메이드", "홍련 : 흑영", "리버렐리오", "앵커 : 이노센트 메이드"],
        "config":  {"first_burst_time": 3.0},
        "expected": (2_145_116_897, 47_314_417),
        "char_avg": {
            "목단":                    17_840_783,
            "마스트 : 로망틱 메이드":   190_412_276,
            "홍련 : 흑영":            1_004_678_262,
            "리버렐리오":               858_536_477,
            "앵커 : 이노센트 메이드":    73_649_098,
        },
    },
    "스쿼드5": {
