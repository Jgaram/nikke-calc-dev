...
|---|---:|---:|---:|
| 라피 : 레드 후드 | 770,652,062 | 6,328,062 | 0.82% |
| 스노우 화이트 : 헤비암즈 | 941,324,314 | 3,580,648 | 0.38% |
| 신데렐라 | 1,046,205,193 | 6,704,991 | 0.64% |
| 리버렐리오 | 863,546,456 | 6,887,930 | 0.80% |
| 홍련 : 흑영 | 967,348,560 | 5,268,879 | 0.54% |
| 네온 : 비전 아이 | 887,388,974 | 8,486,446 | 0.96% |
| 미하라 : 본딩 체인 | 700,845,040 | 7,788,074 | 1.11% |
| 도로시 : 세렌디피티 | 1,136,032,289 | 7,723,382 | 0.68% |
| 디젤 : 윈터 스위츠 | 877,549,859 | 14,087,733 | 1.61% |

> **디젤 : 윈터 스위츠 팀 순서 예외**: `["아니스 : 스타", "크라운", "B3", "디젤 : 윈터 스위츠"]` (4번 슬롯 배치)

### 회귀 테스트 운영 방침

> 기준값 갱신 이력: 2026-05-16 — 크라운 스킬2 passive→stack_reach:릴렉스:20 수정으로 인한 전체 재측정
